...
const buildContainerEnvVars = (env, agentConfig) => ({
  ...
  AGENT_RUNTIME_MODE: env.AGENT_RUNTIME_MODE ?? "",
...
export class SenaAgentContainer extends Container {
  ...
  envVars = {
    ...
    AGENT_RUNTIME_MODE: this.env.AGENT_RUNTIME_MODE ?? "",
    AGENT_MODEL: this.env.AGENT_MODEL ?? "",
    OPENAI_BASE_URL: this.env.OPENAI_BASE_URL ?? "",
    CODEX_API_KEY: this.env.CODEX_API_KEY ?? this.env.OPENAI_API_KEY ?? "",
