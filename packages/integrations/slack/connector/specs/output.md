...
ConnectorOutput은 에이전트 진행 단계를 safe mode Slack 메시지로 누적 렌더링하고, 한계 초과 시 메시지를 분할한다.

## 상위 스펙 연결

- Related Requirements: `SLACK-CONN-FR-004`, `SLACK-CONN-FR-005`, `SLACK-CONN-FR-013`
- Related AC: `SLACK-CONN-AC-004`, `SLACK-CONN-AC-005`, `SLACK-CONN-AC-014`, `SLACK-CONN-AC-015`
...
- 렌더링:
  - 공용 Slack Markdown 패키지의 `markdownToSlack()`으로 safe payload를 만든 뒤 Slack API 호출
